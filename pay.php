...
if(isset($_POST['submit']))
{
	...
	$select="select * from payment where cardno='$cardno' && expirydate='$ccexp' && amount='$amount' ";
	...
	{
		$insert = "insert into payment(cardno,expirydate,amount) values('$cardno','$ccexp','$amount')";
...
<html>
	...
	<body style="background:url(pay.jpeg);
