...
if(isset($_POST['submit']))
{
	...
	$select="select * from passenger where fname='$fname' && mname='$mname' && lname='$lname' && mobileno='$mobno' && age='$age' ";
	...
	{
		$insert = "insert into passenger(fname,mname,lname,mobileno,age) values('$fname','$mname','$lname','$mobno','$age')";
		mysqli_query($conn,$insert);
		echo"<script>alert('enter successfully')</script>";
