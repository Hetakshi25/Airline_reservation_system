...
if(isset($_POST['submit']))
{
	...
	$select ="select * from bookflight where dedate='$dedate' && ardate='$ardate'&& source='$source' && destination='$destination' && fclass='$fclass' && passenger='$passenger' ";
...
/*Following 'if' is for data validation */
			...
			else
	{
		...
		$insert = "insert into bookflight(dedate,ardate,source,destination,fclass,passenger) values('$dedate','$ardate','$source','$destination','$fclass','$passenger')";
		...
		*{
		...
		<form action="" method="POST">		
		 <center><br>
			...
			<tr>
                  <input type="radio" value="1" name="check" ><span>Roundtrip</span> 
				  <input type="radio" value="2" name="check" ><a href="onewayform.php"><span>one way</span></a>
               ...
               <td>
				...
				<!--<td> &nbsp;&nbsp; <label1 for="Returning">Returning Date: </label1>   </td>-->
				 <tr>
					...
					<td>
<!--					<?php //$disabled = $trip = 2 ? "disabled" : ""; ?>
					       
					<?php
					 // if($trip=='2'){
					       //<input type="date" id="select data" name="ardate" disabled >				
					//	   $disabled = $disabled;
					//	   }
					//else{
					//       $disabled = "disabled";				
               ...
               <td>
				...
				<td> &nbsp;&nbsp; <label1 for="Passengers">Passenger: </label1>      </td>
				 <tr>
					...
					<td>
					&nbsp;&nbsp;&nbsp; <input type="number" id="name"  name="passenger" class="pas" required>
			...
			<tr>
				...
				<td>
		<br>
			&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" name="submit" value="book flight" class="btn">
			</td>
		</form>
